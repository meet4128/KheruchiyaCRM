class DimensionConstant {
  /// double infinite constants for various dimensions used in the application.
  static const double infinity = double.infinity;

  /// double constants for various dimensions used in the application.
  ...
  /// This dimesnion is used for web and tablet devices.
  /// do not change this value unless it is absolutely needed.
