          ...
          child: Column(
            ...
            children: [
              ...
              HotelSearchBar(
                ...
                checkInDateEnd: state.checkInDateEnd,
                checkOutDate: state.checkOutDate,
                checkOutDateEnd: state.checkOutDateEnd,
                rooms: state.rooms,
                adults: state.adults,
                ...
                onCheckInEndChanged: (d) => bloc.add(CheckInDateEndChanged(d)),
                onCheckOutChanged: (d) => bloc.add(CheckOutDateChanged(d)),
                onCheckOutEndChanged: (d) => bloc.add(CheckOutDateEndChanged(d)),
