  ...
  static List<Widget> _buildFlightDetailsSections(
    ...
    list.add(
      FlightDetailsSection(
        ...
        departureDateEnd: state.departureDateEnd,
        returnDate: state.returnDate,
        returnDateEnd: state.returnDateEnd,
        bookingType: state.bookingType,
        adultCount: state.travellerBreakdown.adultCount,
        childCount: state.travellerBreakdown.childCount,
        infantCount: state.travellerBreakdown.infantCount,
        ...
        onDepartureDateEndChanged: (d) => bloc.add(DepartureDateEndChanged(d)),
        onReturnDateChanged: (d) => bloc.add(ReturnDateChanged(d)),
        onReturnDateEndChanged: (d) => bloc.add(ReturnDateEndChanged(d)),
        onSwapLocations: () => bloc.add(SwapLocations()),
        onTravellerBreakdownChanged: (breakdown) =>
            bloc.add(TravellerBreakdownChanged(breakdown)),
      ...
      for (var i = 0; i < state.flightSegments.length; i++) {
        ...
        list.add(
          FlightDetailsSection(
            ...
            onTravellerBreakdownChanged: null,
