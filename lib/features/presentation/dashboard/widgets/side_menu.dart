                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      Divider(
                        color: AppColors.dark().borderPrimary.withOpacity(0.5),
                        height: 1,
                        thickness: 1,
                      ),
                      _menuItem(
                        ...
                        PathConstant.createInquiryConstant,
                        NavPage.inquiry,
                        widget.state,
                      ),
                      _menuItem(
                      ...
                      _menuItem(
                        ...
                        PathConstant.manageAmendmentConstant,
                        NavPage.manageAmendment,
                        widget.state,
                      ),
                      _menuItem(
                        context,
                        AssetConstants.icCalendar,
                        PathConstant.calendarConstant,
                        NavPage.calendar,
                        widget.state,
                      ),
                      _menuItem(
                        context,
                        AssetConstants.icCalendar,
                        PathConstant.addFollowUpConstant,
                        NavPage.addFollowUp,
                        widget.state,
                      ),
                      _menuItem(
